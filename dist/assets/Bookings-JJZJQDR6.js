import{r as y,m as v,j as e,u as i,G as M,s as A,U as H,e as I,v as N,w as T,p as C,T as F,x as V,f as z,M as f,y as E,z as q,C as L,A as R,i as Z,P as p,B as j,D as G,E as O,S as Q,d as P,l as w}from"./index-C_TTsSQ5.js";import{a as $,b as K}from"./Filters-CHxJoW6W.js";import{S as U,T as d,I as h,M as u}from"./Menus-BeQozRno.js";const B=y.createContext();function _({children:s}){const[c,t]=y.useState(""),[n,a]=v();function r(o){n.set("page",0),a(n),t(o.target.value)}return e.jsx(B.Provider,{value:{search:c,onSearch:r},children:s})}function k(){const s=y.useContext(B);if(s===void 0)throw new Error("Cannot use useSearch outside of searchContext");return s}const J=i.div`
  display: flex;
  gap: 0.6rem;
